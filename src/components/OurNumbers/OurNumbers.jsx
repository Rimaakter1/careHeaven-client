...
const OurNumbers = () => {
    return (
        <div className="lg:w-10/12 mx-auto w-11/12 text-center mt-40">
            <p className="text-blue-600 font-bold mb-3">Our Numbers</p>
                    ...
                    <div key={stat.id} className="flex flex-col items-center text-center">
                        <div
                            ...
                            ${index % 2 === 0
                                    ...
                                    : "border-2 border-blue-600 text-blue-600 bg-white lg:-mt-10 mt-0"}
                        `}
                        >
                            <h3 className="text-2xl font-bold">{stat.value}</h3>
                            <p className="text-sm">{stat.title}</p>
                        </div>
                        <div className="mt-3 text-gray-600 text-xl">{stat.icon}</div>
                    </div>
                ))}
            </div>
        </div>
